...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		const markupArticle = document.createElement('article');
		...
		this.shadowRoot.appendChild(markupArticle);
	}
	...
	set data(data) {
		...
		const queriedArticle = this.shadowRoot.querySelector('article');
